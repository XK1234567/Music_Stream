...
public class ChillPlaylist extends AppCompatActivity {
    ...
    {
        Intent intent = new Intent(ChillPlaylist.this, MainActivity.class);
        startActivity(intent);
    }

    public void openSearch()
    {
        Intent intent = new Intent(ChillPlaylist.this, SearchPage.class);
        startActivity(intent);
    }

    public void openPlaylists()
    {
        Intent intent = new Intent(ChillPlaylist.this, PlaylistPage.class);
        startActivity(intent);
    }
